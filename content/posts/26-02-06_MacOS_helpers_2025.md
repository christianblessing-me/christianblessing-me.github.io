---
title: "MacOS helpers 2025 edition"
date: 2026-02-06T10:34:11+02:00
draft: false
---

We all love them and use most of them in our every day lifes, little tools/helpers we use to fulfil our goals when working with our system(s). Here's my current list of tools that make my life easier. This is the successor of the [2024](https://christianblessing.me/my-little-macos-helpders-2024-edition/) and [2021 edition](https://christianblessing.me/my-little-macos-helpers-2021-edition/).
...
- [Raycast](https://www.raycast.com/) [Paid - free option available]: app launcher, script launcher, system search - all in one. Completely replaced Alfred5 for me.
...
- [ICE](https://github.com/jordanbaird/Ice) [Free]: open-source menubar manager, replaced HiddenBar for me.
...
- [Obsidian](https://obsidian.md/) [Free - paid version available]: one-stop-shop for taking and organizing notes.
- [Maccy](https://maccy.app/) [Free - paid version available]: MacOS clipboard manager.

### Productivity tools

- [ClaudeCode](https://claude.ai/) [Paid]: CLI version of the Anthropic's coding agent.
...
- [Cursor](https://cursor.com/) [Free - paid version available]: VS Code fork on AI steroids.
